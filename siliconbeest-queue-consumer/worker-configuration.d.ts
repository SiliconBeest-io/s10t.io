/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../siliconbeest/wrangler.rpc-typegen.jsonc --env-file=../scripts/typegen-consumer.env` (hash: a384bc6ff575979dc231672130d4d316)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INSTANCE_DOMAIN" | "REPOSITORY_URL" | "SKIP_SIGNATURE_VERIFICATION" | "DEBUG" | "SENTRY_DSN">> {}
}
