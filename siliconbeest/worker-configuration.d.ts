/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.wrangler.typegen.jsonc --env-file=../scripts/typegen.env` (hash: 8beb6d67b92bf754af32da884a96de61)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INSTANCE_DOMAIN" | "INSTANCE_TITLE" | "INSTANCE_LANGUAGES" | "REPOSITORY_URL" | "REGISTRATION_MODE" | "SKIP_SIGNATURE_VERIFICATION" | "WORKERS_AI_ENABLED" | "WORKERS_AI_RECOMMENDATION_MODEL" | "WORKERS_AI_TRANSLATION_MODEL" | "WORKERS_AI_IMAGE_CAPTION_MODEL" | "WORKERS_AI_RATE_LIMITS" | "WORKERS_AI_RECOMMENDATION_RATE_LIMIT_PERIOD_SECONDS" | "WORKERS_AI_TRANSLATION_RATE_LIMIT_PERIOD_SECONDS" | "WORKERS_AI_IMAGE_DESCRIPTION_RATE_LIMIT_PERIOD_SECONDS" | "OTP_ENCRYPTION_KEY" | "SETUP_SECRET">> {}
}
