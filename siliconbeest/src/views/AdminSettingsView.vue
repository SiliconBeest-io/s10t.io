        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="flex items-center gap-2">
              ...
              <img :src="settings.site_favicon_url || '/siliconbeest.jpg'" class="w-8 h-8 rounded object-contain border border-gray-200 dark:border-gray-700" alt="favicon" />
            </div>
          </div>
          <div>
            ...
            <div class="flex items-center gap-2">
              ...
              <img :src="settings.site_logo_url || '/siliconbeest.jpg'" class="w-8 h-8 rounded object-contain border border-gray-200 dark:border-gray-700" alt="logo" />
            </div>
          </div>
          <div>
